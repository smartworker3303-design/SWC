        ...
        {categoryProducts.map((product) => {
          ...
          return (
            ...
            >
              ...
              {product.subcategory && (
                <span className={`absolute top-4 ${getActiveDiscount(product).hasDiscount ? (product.tag ? "left-44" : "left-24 sm:left-28") : (product.tag ? "left-[4.5rem]" : "left-4")} bg-black/60 border border-gold-500/30 backdrop-blur-sm text-gold-500 text-[9px] font-bold tracking-widest uppercase px-2 py-1 z-20`}>
